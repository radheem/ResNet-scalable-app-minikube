...
class BarAzmoon:
    ...
    def start(self):
        ...
        for rate in self.workload:
            total_seconds += 1
            self.counter += rate
            generator_process = Process(target=self.target_process, args=(rate, self.success_counter))
        ...
        return self.counter, self.success_counter.value
...
if __name__ == "__main__":
    print("BarAzmoon base class, not meant to be run directly.")
